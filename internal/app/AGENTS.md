...
- Slice 2b scenario suites (`go test ./internal/app -run '<name>'`):
  ...
  `TestLaunchEndedRowAfterRestartLeavesStopAsTheExit` (resume stays
  resuming with the rename-back action; stop's own absence observation
