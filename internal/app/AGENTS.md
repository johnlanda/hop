...
- Slice 2b scenario suites (`go test ./internal/app -run '<name>'`):
  ...
  every port interface, with the one comment-dated `Runtime.SendText`
  legacy exception slice 6 deletes); and the feature reference traces
