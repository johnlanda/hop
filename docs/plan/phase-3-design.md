...
RESIDUAL (LAUNCH-8): a pane closed shortly before a restart can still be
present in Herdr's restored session snapshot. The two
`exec_pending`-outlived-its-pane rows above settle `exec_failed`
correctly at the moment they settle — every conjunct they
