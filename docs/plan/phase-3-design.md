...
7. `InjectionFreeDelivery` — brief, task instructions and a manager
   ...
   the log contains ZERO entries for the ENTIRE terminal-input method set
   of section 7 — `pane.send_text`, `pane.send_keys`, `pane.send_input`,
